        ...
        while($baris = pg_fetch_array($result))
            {
                ...
                $latitude=$baris['lat'];
                $longitude=$baris['lng'];
                $dataarray[]=array('id_angkot'=>$id_angkot,'id'=>$id,'id_angkot'=>$id,'name'=>$name,'route_color'=>$route_color, 'destination' => $destination, "latitude"=>$latitude,"longitude"=>$longitude);
            }
