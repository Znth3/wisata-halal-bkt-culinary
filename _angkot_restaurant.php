        ...
        while($baris = pg_fetch_array($result))
            {
                ...
                $dataarray[]=array('destination'=>$destination,'id_angkot'=>$id_angkot,'id'=>$id,'id'=>$id,'name'=>$name,'address'=>$address,'lat'=>$lat,'lng'=>$lng,'description'=>$description,'route_color'=>$route_color,"latitude"=>$latitude,"longitude"=>$longitude);
            }
