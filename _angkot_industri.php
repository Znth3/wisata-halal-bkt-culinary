        ...
        while($baris = pg_fetch_array($result))
            {
                ...
                $dataarray[]=array('id_angkot'=>$id_angkot, 'destination'=>$destination,'id'=>$id,'id'=>$id,'name'=>$name,'lat'=>$lat,'lng'=>$lng,'description'=>$description,'route_color'=>$route_color,"latitude"=>$latitude,"longitude"=>$longitude);
            }
