...
<!-- <section class="panel">
    ...
    <div class="col-sm-4 div-col-md-4 col-lg-4" style=" margin-top:0px;" id="recommend" >
      <section class="panel">
        <div class="panel-body">
          <div class="white-header" style="margin:20px;">
            <a class="btn btn-compose">Recommended Culinary</a>
          </div>
          <div class="box-body" style="margin: 20px; max-height:400px;overflow:auto">
            <div class="slider" id="gallery1">
              <div class="isi-slider">
                <a href="#" title="Cancang" onclick="recKul('11')"><img src="img/culinary/cancang.jpg"></a>
                <a href="#" title="Guali Itiak Lado Mudo" onclick="recKul('4')"><img src="img/culinary/itiak.jpg"></a>
                <a href="#" title="Nasi Kapau" onclick="recKul('22')"><img src="img/culinary/nasikapau.jpg"></a>
                <a href="#" title="Tambungsu" onclick="recKul('3')"><img src="img/culinary/tmbng.jpg"></a>
              </div>
            </div>
          </div>
        </div>                
