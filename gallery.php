      ...
      <header class="header black-bg">
        <div class="sidebar-toggle-box">
          <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation"></div>
            ...
            <!--logo start-->
        <a href="index.php" class="logo"><b>WEBGIS Bukittinggi's Culinary </b>03-1711522006 M.Nur Faiz Putro</a>
        <div class="top-menu">
                      ...
                      <form method="POST" action="_add_comment.php">
                        ...
                        <table id="" class="table">
                          ...
                          if ($_SESSION['C']):
                            $username = $_SESSION['C'];
                          ?>
                            <td<input name="nama" value="<?php $username ?>" hidden></td></tr>
                          <?php
                          else:
                          ?>
...
<script src="_function.js" type="text/javascript">
