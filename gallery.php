...
<body onload="init();detculi_1('<?php echo $_GET['idgallery'] ?>');">
...
<section id="container">
    <header class="header black-bg">
        ...
        <!--logo start-->
        <a href="index.php" class="logo"><b>WEBGIS Culinary </b>03-1711522006 M.Nur Faiz Putro</a>
        <div class="top-menu">
                        ...
                        <div class="col-sm-6"> <!-- information -->
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="box-title" style="text-transform:capitalize;"><b>Detail Information</b>
                                    </h2>
                                </header>

                                <div class="panel-body">
                                    <table id="hasilcaridet" class="table">
                            ...
                            <section class="panel" id="review">
                                <header class="panel-heading">
                                    <h4 class="box-title" style="text-transform:capitalize;"><b> Visitor's Reviews</b>
                                    </h4>
                                </header>
                                ...
                                <div class="panel-body">
                                    <form method="POST" action="_add_comment.php">
                                        ...
                                        <table id="" class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td><Textarea placeholder="" name="comment"></Textarea></td>
                                            </tr>
                                            <tr>
                                                ...
                                                ?>
                                                <td
                                                <input name="nama" value="<?php $username ?>" hidden></td></tr>
                                            <?php
                                            else:
                                                ?>
                                                <td><input type="text" required name="nama"></td></tr>
                                            <?php
                                            endif;
                                            ?>
                                    ...
                                    <table class="table">
                                        ...
                                        while ($rows = pg_fetch_array($result)) {
                                            $nama = $rows['name'];
                                            $komen = $rows['comment'];
                                            echo "<tr><td>$nama</td><td>$komen</td></tr>";
                                        }
                                                    ...
                                                    if (strpos($id, "H") !== false) {  //Hotel
                                                        ...
                                                        while ($baris = pg_fetch_assoc($hasil)) {
                                                            if (($baris['gallery_culinary'] == '-') || ($baris['gallery_culinary'] == '')) {
                                                                ...
                                                                echo "<a href='img/" . $baris['gallery_culinary'] . "'><img src='img/" . $baris['gallery_culinary'] . "'></a>";
                                                            }
                                                        }
